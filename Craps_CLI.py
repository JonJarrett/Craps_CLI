...
# todo check min max bet validity
# todo add way to check if bet is a proper bet
def place_bet():
    while True:
        ...
        if additional_bet in ["no", "n", "nope"]:
            ...
            if additional_bet in ["yes", "y", "Yes", "Y", "yep"]:
    ...
    while True:
        ...
        if come_out == 2:
            if pass_bets['pass'] > 0:
                ...
                pass_bets['pass'] = 0
            if dont_pass_bets['dont pass'] > 0:
                print("Winner!")
                balance = balance + dont_pass_bets['dont pass']
            main()
        if come_out == 3:
            if pass_bets['pass'] > 0:
                print("You Lose")
        ...
        if come_out == 12:
            if pass_bets['pass'] > 0:
                ...
                pass_bets['pass'] = 0
            if dont_pass_bets['dont pass'] > 0:
                print("Boxcars, Don't Pass bets are a push.")
            main()
        print(f"$" + str(balance))
...
# todo  create way to check if user has enough $ to bet
# todo remove global variables someday
